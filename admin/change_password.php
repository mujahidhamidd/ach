...
if (isset($_POST['newpassword'],$_POST['oldpassword']) ){
  ...
  $get_patient_data = mysqli_query($connect,"SELECT password FROM admins WHERE job_number ='$job_number' "); 
  ...
  if($rows > 0 )
  {
    ...
    $update_password = mysqli_query($connect,"UPDATE `admins` SET `password` = '$newpassword'  WHERE `admins`.`job_number` = $job_number;
    "); 
            ...
            <div class="panel panel-default">
              ...
              <form id="login" action="" method="post" >
                  ...
                  <div class="form-group">
                    ...
                    border-radius: 20px;
                    width: 100%;" name="confirm password" type="confirmpassword" class="form-control" placeholder="Confirm Password">
                  </div>
